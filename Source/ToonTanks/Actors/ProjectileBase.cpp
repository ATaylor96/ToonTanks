...
AProjectileBase::AProjectileBase()
{
	...
	ProjectileMovement->InitialSpeed = MovemementSpeed;
	ProjectileMovement->MaxSpeed = MovemementSpeed;

	ParticleTrail = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("Projectil Trail"));
